...
// // function WalkthroughContent({ content }: WalkthroughContentProps) {
// //   return (
...
// //         {/* Boss tips */}
// //         {content.is_boss && content.boss_tips && content.boss_tips.length > 0 && (
// //           <div className="mb-4 p-4 bg-gray-800/30 rounded-lg border border-gray-700/50">
// //             <p className="text-sm font-medium text-gray-400 mb-2">Boss Tips</p>
// //             <ul className="space-y-1.5">
// //               {content.boss_tips.map((tip, idx) => (
...
// //           <div className={`grid gap-3 ${content.images.length === 1 ? 'grid-cols-1' : 'grid-cols-1 sm:grid-cols-2'}`}>
