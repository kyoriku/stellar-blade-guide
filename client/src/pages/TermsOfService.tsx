    ...
    <div className="min-h-main bg-primary">
      ...
      <div className="container mx-auto px-3 py-8 max-w-4xl">
        ...
        <div className="bg-secondary shadow-lg rounded-lg p-4 md:p-6 space-y-6 text-gray-300 leading-relaxed border border-gray-800">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">User Accounts</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">Comments & Community Conduct</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">General User Responsibilities</h2>
            <ul className="list-disc list-inside mt-2 ml-4 space-y-1">
