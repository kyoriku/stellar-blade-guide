    ...
    <div className="min-h-main bg-primary">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-secondary shadow-lg rounded-lg p-4 md:p-6 space-y-6 text-gray-300 leading-relaxed border border-gray-800">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Service Description</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">User Accounts</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Comments & Community Conduct</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">General User Responsibilities</h2>
            <ul className="list-disc list-inside mt-2 ml-4 space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Disclaimers & Liability</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Third-Party Links</h2>
            <p>External links are provided for convenience. We are not responsible for third-party content or practices.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Changes & Termination</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Governing Law</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-100">Contact</h2>
