    ...
    <div className="min-h-main bg-primary">
      ...
      <div className="container mx-auto px-3 py-8 max-w-4xl">
        ...
        <div className="bg-secondary shadow-lg rounded-lg p-4 md:p-6 space-y-6 text-gray-300 leading-relaxed border border-gray-800">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">AI Comment Moderation</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">Cookies, Sessions & Local Storage</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-gray-200">Changes to This Policy</h2>
