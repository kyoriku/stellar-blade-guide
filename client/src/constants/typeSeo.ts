...
import type { CollectibleSlug, UpgradeSlug, CosmeticSlug } from './navigation';
import seo from './seo.json';

export type TypeSlug = CollectibleSlug | UpgradeSlug | CosmeticSlug;
...
// per category there so cross-category URLs keep 404ing. The three annotated
