...
src/
  ...
  utils/             image URL/srcset helpers (image.ts), image cache, slug
                     generation and dedup, TOC builders, description parser,
                     username validation
