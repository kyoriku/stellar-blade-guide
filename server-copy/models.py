...
#     collectibles = relationship('Collectible', back_populates='type')
...
#     type_id = Column(Integer, ForeignKey('collectible_types.id'), nullable=False)
#     title = Column(String(255), nullable=False)
#     description = Column(JSONB, nullable=False)
#     display_order = Column(Integer, nullable=False)
    
#     location = relationship('Location', back_populates='collectibles')
#     type = relationship('CollectibleType', back_populates='collectibles')
